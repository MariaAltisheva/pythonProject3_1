...
class PostDAO:
    """Менеджер постов - загружает, ищет, вытаскиват по пк и пользователю"""
    ...
    def _load_data(self):
        ...
        try:
            ...
            raise DataSourceError(f'Не удатся получить данные из файла {self.path}')
    ...
    def get_all(self):
        """Получает все посты. Выводит список экземпляров класса Post"""
    ...
    def search_in_content(self, substring):
        """Ищет посты, где в контенте встрчается substring"""
